...
const SettingsItem = ({icon,title,onPress,textStyle,showArrow=true}:SettingsItemProps)=>{
  return(<TouchableOpacity className='flex flex-row items-center justify-center justify-between py-3'  onPress={onPress}>
    <View className='flex flex-row items-cneter gap-3'>
...
const profile = () => {
  ...
  return (
    <SafeAreaView className='h-full bg-white'>
      <ScrollView  showsVerticalScrollIndicator={true} contentContainerClassName="px-7 pb-30">
